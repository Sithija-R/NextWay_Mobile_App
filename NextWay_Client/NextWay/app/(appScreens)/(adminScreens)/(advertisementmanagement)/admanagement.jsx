      ...
      {selectedAd && (
        ...
        >
         ...
         <Text style={styles.modalText}>{t("User Id")}:</Text>
                ...
                <Text style={styles.modalText}>{t("description english")}:</Text>
                <Text style={styles.modalDescription}>
                  {selectedAd.description_en}
                </Text>
                <Text style={styles.modalText}>{t("description sinhala")}:</Text>
                <Text style={styles.modalDescription}>
                ...
                <View>
                  <TouchableOpacity
                    ...
                    onPress={() => handleAccept(selectedAd.id, selectedAd.userId)}
                  >
                    <Text
                      style={{
                        color: "white",
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => handleDecline(selectedAd.id, selectedAd.userId)}
                  >
                    <Text
                      style={{
                        color: "white",
